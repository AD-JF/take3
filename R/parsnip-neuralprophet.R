...
#'
#' @export
neural_prophet <- function(mode = "regression", growth = NULL, changepoints = NULL, n_changepoints = NULL, changepoint_range = NULL,
                           yearly_seasonality = NULL, weekly_seasonality = NULL, daily_seasonality = NULL,
                           season = NULL, trend_reg = NULL, trend_reg_threshold = NULL, seasonality_mode = NULL,
                           num_hidden_layers = NULL, d_hidden = NULL, ar_reg = NULL, learning_rate = NULL,
                           epochs = NULL, batch_size = NULL, loss_func = NULL, normalize_y = NULL,
  ...
  args <- list(
    ...
    changepoints         = rlang::enquo(changepoints),
    n_changepoints           = rlang::enquo(n_changepoints),
    changepoint_range         = rlang::enquo(changepoint_range),
    yearly_seasonality        = rlang::enquo(yearly_seasonality),
    weekly_seasonality        = rlang::enquo(weekly_seasonality),
    daily_seasonality         = rlang::enquo(daily_seasonality),
    ...
    ar_reg               = rlang::enquo(ar_reg),
    learning_rate                = rlang::enquo(learning_rate),
